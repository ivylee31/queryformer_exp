...
import bao_net
from feature import TreeFeaturizer
import wandb
...
class BaoRegression:
    ...
    def fit(self, X, y):
        ...
        self.__net = bao_net.BaoNet(in_channels)
        ...
        for epoch in range(100):
            ...
            wandb.init(project='queryformer')
            #wandb.watch(BaoRegression)
            wandb.log({"loss":loss_accum,"epoch":epoch})
